$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Phil and Estelle's Wedding",

            // Event start date
            start: new Date('Oct 22, 2022 16:00'),
            ...
            end: new Date('Oct 22, 2022 22:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbzFHaSpeD-KsPHOYsgH53sksf1kZPEO-BJ_zrCn4eHZ8VyAo37OIP6GDiVmZIrFAJbSJA/exec', data)
                .done(function (data) {
                    console.log(data);
